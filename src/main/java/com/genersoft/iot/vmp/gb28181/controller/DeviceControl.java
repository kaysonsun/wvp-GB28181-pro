...
public class DeviceControl {
    ...
    public DeferredResult<WVPResult<String>> guardApi(@PathVariable String deviceId,
    ...
    @GetMapping("/reset_alarm/{deviceId}/{channelId}")
    public DeferredResult<WVPResult<String>> resetAlarm(@PathVariable String deviceId,
